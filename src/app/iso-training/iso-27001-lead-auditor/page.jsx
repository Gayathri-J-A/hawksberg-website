...
export const metadata = { title: "ISO 27001 Lead Auditor Training", description: "ISO 27001 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-27001-lead-auditor" } };
