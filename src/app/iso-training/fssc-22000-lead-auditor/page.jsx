...
export const metadata = { title: "FSSC 22000 Lead Auditor Training", description: "FSSC 22000 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/fssc-22000-lead-auditor" } };
  ...
  return (
    ...
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${fssc22000Img.src})`,
        }}
      >
        {/* Dark Overlay */}
