...
export const metadata = { title: "ISO 45001 Lead Auditor Training", description: "ISO 45001 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-45001-lead-auditor" } };
