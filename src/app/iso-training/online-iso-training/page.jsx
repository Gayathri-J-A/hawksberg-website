...
export const metadata = { title: "Online ISO Training", description: "Online ISO training course content from Hawksberg International.", alternates: { canonical: "/iso-training/online-iso-training" } };
  ...
  return (
    <Layout>
      ...
      <section
        ...
        "
        style={{
          backgroundImage: `url(${onlineTrainingImg.src})`,
        }}
      >
