...
export const metadata = { title: "ISO 13485 Internal Auditor Training", description: "ISO 13485 internal auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-13485-internal-auditor" } };
export default function ISO13485InternalAuditor() {
  ...
  style={{ backgroundImage: `url(${iso13485Img.src})` }}
>
