...
export const metadata = { title: "ISO 22000 Lead Auditor Training", description: "ISO 22000 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-22000-lead-auditor" } };
