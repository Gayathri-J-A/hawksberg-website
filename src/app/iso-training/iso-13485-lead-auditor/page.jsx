...
export const metadata = { title: "ISO 13485 Lead Auditor Training", description: "ISO 13485 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-13485-lead-auditor" } };
  ...
  return (
    ...
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${iso13485Img.src})`,
        }}
      >
