...
export const metadata = { title: "ISO 22301 Internal Auditor Training", description: "ISO 22301 internal auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-22301-internal-auditor" } };
