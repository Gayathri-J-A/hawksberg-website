...
export const metadata = { title: "ISO 50001 Internal Auditor Training", description: "ISO 50001 internal auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-50001-internal-auditor" } };
