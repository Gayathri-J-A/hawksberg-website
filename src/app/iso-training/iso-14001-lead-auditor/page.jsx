...
export const metadata = { title: "ISO 14001 Lead Auditor Training", description: "ISO 14001 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-14001-lead-auditor" } };
