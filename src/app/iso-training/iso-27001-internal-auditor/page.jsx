...
export const metadata = { title: "ISO 27001 Internal Auditor Training", description: "ISO 27001 internal auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-27001-internal-auditor" } };
  ...
  return (
    <Layout>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${iso27001Img.src})`,
        }}
      >
        {/* Dark overlay */}
