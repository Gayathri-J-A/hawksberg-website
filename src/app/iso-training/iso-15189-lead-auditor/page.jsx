...
export const metadata = { title: "ISO 15189 Lead Auditor Training", description: "ISO 15189 lead auditor training course content from Hawksberg International.", alternates: { canonical: "/iso-training/iso-15189-lead-auditor" } };
