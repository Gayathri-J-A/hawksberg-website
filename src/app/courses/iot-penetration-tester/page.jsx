...
export const metadata = { title: "IoT Penetration Tester Course", description: "IoT penetration testing course content focused on device and application security.", alternates: { canonical: "/courses/iot-penetration-tester" } };
export default function IoTPenetrationTester() {
  return (
    <Layout>
     {/* =========================================================
    HERO SECTION
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            ...
            >
              <div className="w-full max-w-[400px] lg:ml-auto">
                <EnquiryForm
                  compact
                  sourcePage="iot-penetration-tester"
                />
              </div>
            </aside>
