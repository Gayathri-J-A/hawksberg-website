...
export const metadata = { title: "Reverse Engineering and Malware Analysis", description: "Reverse engineering and malware analysis course content with practical security topics.", alternates: { canonical: "/courses/reverse-engineering" } };
