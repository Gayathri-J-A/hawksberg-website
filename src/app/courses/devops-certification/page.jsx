...
const learningAreas = [
  {
    ...
    description:
      "Learn modern Git workflows, repository management, branching strategies and collaborative version-control practices used in professional development teams.",
  },
  {
    title: "Docker & Containerization",
    description:
      "Understand container concepts and learn how Docker can be used to package, deploy and manage applications consistently across environments.",
  },
  {
    title: "Jenkins & CI/CD",
    description:
      "Build automated CI/CD workflows using Jenkins and understand how continuous integration and continuous delivery improve software release processes.",
  },
  {
    title: "Kubernetes",
    description:
      "Learn the fundamentals of Kubernetes for container orchestration, application deployment, scaling and management in modern cloud environments.",
  },
  {
    title: "AWS Deployment",
    description:
      "Understand cloud deployment concepts and learn how applications can be deployed and managed using AWS infrastructure and services.",
  },
  {
    title: "Automation & Infrastructure",
    description:
      "Explore automation practices and infrastructure management techniques that help teams build reliable and repeatable DevOps environments.",
  },
];
...
export const metadata = { title: "DevOps Certification Course", description: "DevOps certification course content with practical development and operations topics.", alternates: { canonical: "/courses/devops-certification" } };
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            ...
            <main className="space-y-16 lg:col-span-2">
              ...
              <section>
                ...
                <div className="mt-8 space-y-4">
                  {[
                    "Developers who want to build expertise in modern DevOps practices.",
                    "System administrators looking to move into DevOps and cloud infrastructure roles.",
                    "IT professionals interested in CI/CD and cloud-native technologies.",
                    "Software professionals who want to automate development and deployment workflows.",
                    "Students planning to build a professional career in DevOps and cloud engineering.",
                  ].map((item) => (
                    <div
                      key={item}
                      className="
              ...
              >
                ...
                <h2 className="mt-4 font-display text-3xl md:text-4xl">
                  Build Your Career in DevOps
                </h2>

                <p className="mt-4 max-w-2xl text-sm leading-8 text-white/70">
                  Develop practical DevOps skills through hands-on training
                  covering Git, Docker, Jenkins, Kubernetes, CI/CD, AWS,
            ...
            >
              <div className="w-full max-w-[400px] lg:ml-auto">
                <EnquiryForm
                  compact
                  sourcePage="devops-certification"
                />
              </div>
            </aside>
