...
export const metadata = { title: "Android Penetration Tester Course", description: "Android penetration testing course content focused on mobile application security.", alternates: { canonical: "/courses/android-penetration-tester" } };
