...
export const metadata = { title: "Penetration Testing Course", description: "Penetration testing course content with practical vulnerability assessment topics.", alternates: { canonical: "/courses/penetration-testing" } };
