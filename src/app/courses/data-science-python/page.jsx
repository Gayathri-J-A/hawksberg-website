...
export const metadata = { title: "Data Science with Python", description: "Data science with Python course content covering practical programming and analysis topics.", alternates: { canonical: "/courses/data-science-python" } };
