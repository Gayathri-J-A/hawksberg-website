...
export const metadata = { title: "CCNP Training", description: "CCNP training course content for advanced enterprise networking skills.", alternates: { canonical: "/courses/ccnp" } };
