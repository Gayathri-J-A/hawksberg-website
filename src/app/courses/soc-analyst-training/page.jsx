...
export const metadata = { title: "SOC Analyst Training", description: "SOC analyst training course content with practical security operations learning.", alternates: { canonical: "/courses/soc-analyst-training" } };
