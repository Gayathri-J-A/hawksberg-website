...
export const metadata = { title: "Bug Bounty Course", description: "Bug bounty course content covering practical cybersecurity and vulnerability discovery topics.", alternates: { canonical: "/courses/bug-bounty" } };
