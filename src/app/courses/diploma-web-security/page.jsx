...
export const metadata = { title: "Diploma in Web Security", description: "Web security diploma course content covering practical application security topics.", alternates: { canonical: "/courses/diploma-web-security" } };
