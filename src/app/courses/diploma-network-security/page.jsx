...
const course = {
  ...
  whyJoinTitle: "Why Join Diploma in Network Security?",
...
export const metadata = { title: "Diploma in Network Security", description: "Network security diploma course content covering practical infrastructure security topics.", alternates: { canonical: "/courses/diploma-network-security" } };
export default function DiplomaNetworkSecurity() {
  return (
    <Layout>
        ...
        <div className="space-y-10 lg:col-span-2">
          ...
          <section className="grid gap-6 sm:grid-cols-3">
            ...
            {[
              ...
              [
                "Hands-on labs",
                "Real-world network security challenges in a practical environment.",
              ],
              [
                "Career support",
