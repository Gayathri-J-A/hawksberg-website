...
export const metadata = { title: "Certified Cyber Security Professional", description: "Certified cyber security professional course content with practical cybersecurity learning.", alternates: { canonical: "/courses/cyber-security-professional" } };
