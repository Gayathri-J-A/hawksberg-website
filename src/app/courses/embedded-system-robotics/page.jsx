...
export const metadata = { title: "Embedded Systems and Robotics Course", description: "Embedded systems and robotics training course content with practical learning topics.", alternates: { canonical: "/courses/embedded-system-robotics" } };
export default function EmbeddedSystemRobotics() {
  return (
    <Layout>
    {/* =========================================================
    HERO SECTION
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            ...
            <main className="space-y-16 lg:col-span-2">
                  ...
                  {[
                    {
                      ...
                      text:
                        "Build a strong foundation in Embedded C programming and understand how software interacts with embedded hardware.",
                    },
                    {
                      title: "Arduino Development",
                      text:
                        "Learn to develop practical embedded applications using Arduino boards, sensors and connected components.",
                    },
                    {
                      title: "Raspberry Pi",
                      text:
                        "Understand Raspberry Pi-based embedded projects and practical hardware-software integration.",
                    },
                    {
                      title: "Sensors & Hardware",
                      text:
                        "Learn how sensors and hardware components can be interfaced with embedded systems for intelligent applications.",
                    },
                    {
                      title: "Robotics",
                      text:
                        "Explore robotics concepts and develop practical understanding of robotic systems and automation.",
                    },
                    {
                      title: "IoT Projects",
                      text:
                        "Apply embedded and IoT concepts through practical projects involving connected devices and intelligent systems.",
                    },
                  ].map((item) => (
                    <article
                      key={item.title}
              ...
              >
                ...
                <h2 className="mt-4 font-display text-3xl md:text-4xl">
                  Build Your Future in Embedded &amp; Robotics
                </h2>

                <p className="mt-4 max-w-2xl text-sm leading-8 text-white/70">
                  Develop practical skills in embedded programming, robotics,
                  hardware interfacing and IoT through hands-on learning and
                  real-world projects.
                </p>
            ...
            >
              <div className="w-full max-w-[400px] lg:ml-auto">
                <EnquiryForm
                  compact
                  sourcePage="embedded-system-robotics"
                />
              </div>
            </aside>
          </div>
