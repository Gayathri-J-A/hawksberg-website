...
export const metadata = { title: "AWS Basic Training", description: "AWS basic training course content covering foundational cloud learning topics.", alternates: { canonical: "/courses/aws-basic-training" } };
