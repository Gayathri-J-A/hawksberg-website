...
export const metadata = { title: "Network Penetration Tester Course", description: "Network penetration testing course content focused on practical infrastructure security.", alternates: { canonical: "/courses/network-penetration-tester" } };
