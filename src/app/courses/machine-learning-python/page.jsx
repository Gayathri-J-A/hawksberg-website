...
export const metadata = { title: "Machine Learning with Python", description: "Machine learning with Python course content covering practical programming topics.", alternates: { canonical: "/courses/machine-learning-python" } };
